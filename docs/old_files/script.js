...
function populatePDFData() {
    ...
    document.getElementById('pdf-skills-ai-title').textContent = t.skillsAI;
    document.getElementById('pdf-projects-title').textContent = t.projectsTitle.toUpperCase();
    document.getElementById('pdf-project1-desc').innerHTML = t.project1Desc;
